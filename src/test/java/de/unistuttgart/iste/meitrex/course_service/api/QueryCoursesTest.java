...
class QueryCoursesTest {
    ...
    void testGetAllCoursesWithPagination(final GraphQlTester tester) {
        final var data = Stream.of(
                        TestUtils.dummyCourseBuilder().title("Course 1").build(),
                        TestUtils.dummyCourseBuilder().title("Course 2").build(),
                        TestUtils.dummyCourseBuilder().title("Course 3").build(),
                        TestUtils.dummyCourseBuilder().title("Course 4").build())
                .map(courseRepository::save)
                .toList();
    ...
    void testGetAllCoursesWithSort(final GraphQlTester tester) {
        final var data = Stream.of(
                        TestUtils.dummyCourseBuilder().description("A").build(),
                        TestUtils.dummyCourseBuilder().description("B").build(),
                        TestUtils.dummyCourseBuilder().description("C").build(),
                        TestUtils.dummyCourseBuilder().description("D").build())
                .map(courseRepository::save)
                .toList();
    ...
    void testGetCoursesWithFilter(final GraphQlTester tester) {
        final var data = Stream.of(
                        TestUtils.dummyCourseBuilder().title("Course 1").description("A").build(),
                        TestUtils.dummyCourseBuilder().title("Course 2").description("B").build(),
                        TestUtils.dummyCourseBuilder().title("Course 3").description("C").build(),
                        TestUtils.dummyCourseBuilder().title("Course 4").description("D").build())
                .map(courseRepository::save)
                .toList();
